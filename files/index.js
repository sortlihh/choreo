...
const port = process.env.SERVER_PORT || process.env.PORT || 5010;        
const UUID = process.env.UUID || 'a8b178d9-bf8c-436d-bb12-71ba0be0740a'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.chr257.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYjJjNzM3YjgwNjQ5YzFiMDYwMTRjMGEyZjc1MjRhMjciLCJ0IjoiNjg1OWZhYjktMDY2My00MDJmLThkNDgtOGRlMzg5Y2IyMmFmIiwicyI6IllUQXlNR1V6TW1FdFpqazJOeTAwWW1Ka0xUa3pNamt0Tm1Zek1HUXlNekJrTmpZdyJ9';
